...
function init()
{
	...
	if ((!defined('R2_UPLOADS_KEY') || !defined('R2_UPLOADS_SECRET'))) {
		return;
	}
	...
	add_action('wp_privacy_personal_data_export_file_created', __NAMESPACE__ . '\move_temp_personal_data_to_r2', 1000);
}
...
{
	printf(
		'<div class="error"><p>The R2 Uploads plugin requires PHP version 5.5.0 or higher. Your server is running PHP version %s.</p></div>',
		PHP_VERSION
	);
}
 ...
 */
function move_temp_personal_data_to_r2(string $archive_pathname)
{
